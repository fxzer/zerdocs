...
- `@media (max-width: 575.98px)`：超小屏幕，手机竖屏模式。
- `@media (min-width: 576px) and (max-width: 767.98px)`：小屏幕，手机横屏模式。
- `@media (min-width: 768px) and (max-width: 991.98px)`：中等屏幕，平板电脑。
- `@media (min-width: 992px) and (max-width: 1199.98px)`：大屏幕，笔记本电脑。
- `@media (min-width: 1200px)`：超大屏幕，台式电脑或更大尺寸的显示器。
